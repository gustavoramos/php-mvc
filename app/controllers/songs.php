...
class Songs extends Controller
{
    ...
    // Método que carrega a página de nova música: http://php-mvc/songs/newsong
    public function newSong()
    {
        // load views. within the views we can echo out $song easily
        require APP . 'views/_templates/header.php';
        require APP . 'views/songs/new.php';
        require APP . 'views/_templates/footer.php';
    }
    ...
    public function addSong()
    {
        ...
        if (isset($_POST["submit_add_song"])) {
            ...
            $this->model->addSong($_POST["artista"], $_POST["faixa"],  $_POST["link"]);
        }
    ...
    public function updateSong()
    {
        ...
        if (isset($_POST["submit_update_song"])) {
            ...
            $this->model->updateSong($_POST["artista"], $_POST["faixa"],  $_POST["link"], $_POST['song_id']);
        }
